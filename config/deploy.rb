  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/humbledaisy_website"
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/humbledaisy_website-puma.sock"
  ...
  namespace :deploy do
    ...
    #       execute("ln -nfs /home/deployer/apps/humbledaisy_website/current/config/nginx.conf /etc/nginx/sites-enabled/humbledaisy_website && rm /etc/nginx/sites-enabled/default")
    #     end
    #   end
    # end
